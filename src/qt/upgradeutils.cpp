...
QString UpgradeUtils::ToQString(const std::string& string)
{
    return QString::fromStdString(string);
}

bool UpgradeUtils::SnapshotMain()
{
    ...
    boost::thread SnapshotDownloadThread(std::bind(&UpgradeUtils::DownloadSnapshot, this)); // thread runs free
    ...
    boost::thread SnapshotExtractThread(std::bind(&UpgradeUtils::ExtractSnapshot, this));
...
void UpgradeUtils::DownloadSnapshot()
{
...
void UpgradeUtils::ExtractSnapshot()
{
...
void UpgradeUtils::ErrorMsg(const std::string& text, const std::string& informativetext)
{
...
int UpgradeUtils::Msg(const std::string& text, const std::string& informativetext, bool question)
{
    QMessageBox Msg;
...
bool UpgradeUtils::CancelOperation()
{
